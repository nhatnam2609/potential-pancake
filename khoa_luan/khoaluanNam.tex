...
\item Chương 2: Phân tích giá trị kì dị (SVD). Trong chương này, chúng tôi giới thiệu về SVD và các tính chất của ma trận liên quan đến SVD.
...
Có 2 hai chuẩn của vector thường được đùng là \ref{eqn:norm1} và \ref{eqn:norm2}
\begin{equation}
	\label{eqn:norm1}
...
Tronng phần này chúng tôi sẽ nhắc lại những kiến thức cơ bản trong xác xuất thống kê.
\subsection{Kỳ vọng}
...
\end{bmatrix}
\]
- Bước 3: Tính ma trận $\mathbf{A}_r $ và $\mathbf{B}_r^{T}$
\begin{equation}
...
\end{figure}
\newpage
\section{ ứng dụng PCA trong nhận dạng khuôn mặt}
...
Ma trận lỗi là một cách hữu ích để trực quan hóa hiệu suất của bộ phân loại. Mỗi hàng của ma trận tương ứng với lớp thực tế, và mỗi cột tương ứng với lớp dự đoán.
